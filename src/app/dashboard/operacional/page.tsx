...
import { Activity, Zap, GitMerge, RefreshCw } from "lucide-react";
...
export default function DashboardOperacionalPage() {
  ...
  const cplData = useMemo(() => getFilteredCplByPlatform(filters), [filters]);
  ...
  return (
    <AppShell>
      ...
      <div className="mb-6 grid grid-cols-1 gap-6 lg:grid-cols-2">
        <Card title="Leads Diários" subtitle="Pagos vs orgânicos — período filtrado">
        ...
        <Card title="CPL por Plataforma" subtitle="Custo por lead — campanhas pagas">
          {cplData.length === 0 ? (
